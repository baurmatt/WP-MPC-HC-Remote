...
namespace MPC_Remote
{
    public class SocketClient
    {
        ...
        /// <summary>
        /// Methode for checking the connection to the server
        /// </summary>
        /// <param name="HostName">The hostname or ip address of the remote pc</param>
        /// <param name="Port">The port of the remote pc</param>
        /// <returns>If connection is avaiable or not</returns>
        public static bool IsConnectionAvailable(string HostName, int Port)
        {
            SocketClient sc = new SocketClient();
            if (sc.Connect(HostName, Port) == "Success")
            {
                return true;
            }
            else
